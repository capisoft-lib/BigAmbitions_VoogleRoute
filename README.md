...
- **Readable windows** — **Options → Mods → Window size** scales bookmarks, history, settings and confirmation dialogs from 100% to 160%; the maximum adapts to the screen resolution
