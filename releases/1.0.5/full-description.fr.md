...
Voogle Route enrichit Voogle Maps avec une ligne d’itinéraire claire au sol, la navigation à pied, des trajets routiers adaptés aux véhicules, le recours au métro, des favoris, un historique des visites et un voyage rapide facultatif. Le même paquet Voogle Route 1.0.5 prend en charge Big Ambitions EA 0.11 et la version 1.0.
...
La version 1.0.5 conserve les destinations de bâtiments après l’arrivée en voiture pour se garer puis poursuivre à pied, sans déclencher la marche automatique. Uniquement hors mission.
...
[b]Nouveautés de la version 1.0.5[/b]
...
[*]Abonnez-vous à Voogle Route 1.0.5 et activez-le
