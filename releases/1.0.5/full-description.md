[b]Voogle Route 1.0.5[/b]

Voogle Route extends Voogle Maps with a clear on-ground route line, walking navigation, road-aware driving routes, subway fallback, bookmarks, visit history and optional fast travel. The same Voogle Route 1.0.5 package supports Big Ambitions EA 0.11 and 1.0.
...
Version 1.0.5 keeps ordinary building destinations active after arrival by car for parking and walking guidance, without automatically starting Auto Walk. Applies outside missions.
...
[*]Subscribe to and enable Voogle Route 1.0.5
