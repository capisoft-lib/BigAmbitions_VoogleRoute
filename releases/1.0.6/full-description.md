...
Voogle Route extends Voogle Maps with a clear on-ground route line, walking navigation, road-aware driving routes, subway fallback, bookmarks, visit history and optional fast travel. The same Voogle Route 1.0.6 package supports Big Ambitions EA 0.11 and 1.0.
...
Version 1.0.6 adds a GPS app on Aluna's Phone Pages with a heading-up vanilla map inside the HUD phone.
...
[b]Optional for the phone GPS app[/b]

[list]
[*][b]Aluna's Phone Pages[/b] — required to open the Voogle Route icon on the HUD phone home screen
[/list]

[b]What's new in 1.0.6[/b]

[list]
[*][b]Phone GPS app[/b] — heading-up vanilla map on Aluna's Phone Pages, bookmark search, recenter and a shortcut to the full city map
[*][b]Resume after overlays[/b] — closing BizMan or the city map returns to the in-phone GPS with the same map framing
[*][b]Pan without walking[/b] — dragging the phone map no longer issues ground click-to-move on the player
[*][b]Long-press pin[/b] — hold a still point to drop a pin, then confirm with Set destination
[/list]
...
[*][b]Vehicle arrival guidance[/b] — ordinary building destinations stay active after arrival by car for parking and walking guidance, without automatically starting Auto Walk outside missions
...
[*]Subscribe to and enable Voogle Route 1.0.6
[*]For the phone GPS app, also subscribe to and enable Aluna's Phone Pages
[*]Restart Big Ambitions after all Workshop items finish updating
[/list]
